                ...
                <div class="container-fluid">
                        ...
                        <div class="col-lg-6 col-6">
                            <form data-ajax="false" target="_blank" method="post">
                                <div data-role="fieldcontain">
                                    <div class="btn-group" id="btnAddProject" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-success" data-toggle="modal"
                                            data-target="#modal_add"><i class="fa fa fa-tags" aria-hidden="true"></i>
                                            เพิ่ม Project</button>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12">
                            <table name="tableProject" id="tableProject" class="table table-bordered table-striped">
                                <thead style=" background-color:#D6EAF8;">
                                    <tr>
                                        <th width="20%">รหัส Project</th>
                                        <th width="50%">ชื่อ Project</th>
