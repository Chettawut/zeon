<?php
	...
	$sql = "SELECT a.socode,a.sfdate,c.stcode,c.stname1,a.cuscode,d.cusname,b.supstatus,b.amount,b.unit FROM `sfmaster` as a inner join sfdetail as b on (a.socode=b.socode) inner join stock as c on (c.stcode=b.stcode) left outer join customer as d on (a.cuscode=d.cuscode) ";
