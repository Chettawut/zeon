<?php
	...
	$sql = "SELECT b.rrcode,b.rrno,c.stcode,c.stname1,b.amount as recamount,d.amount,b.pocode,b.unit,b.price,b.discount,b.rrstatus,b.places ";
	$sql .= "FROM rrdetail as b inner join stock as c on (c.stcode=b.stcode) inner join podetail as d on (d.pocode=b.pocode and d.stcode=b.stcode) ";
	$sql .= "where b.rrcode = '".$_POST['idcode']."' and b.giveaway = '0' order by b.rrno  ";
